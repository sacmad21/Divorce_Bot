...
def answer_in_general():
    ...
    try:
        ...
        print("chain initialzation started 1")
...
If the question is out of context or outside the domain of divorce, inform the user accordingly. 
Do NOT answer the question—only reformulate it if needed, or return it as is if it's already self-contained."""
            ...
            qa_system_prompt = """
                ...
                - Only answer if the question is strictly related to the topic of divorce.
                - Do NOT answer any health-related questions.
                - If you don’t know the answer, simply respond with: "I don't know the answer to this question as it is out of the context of divorce. If you have any question related to divorce I'll be happy to help".
            ...
            print("chain initialzation started 2")
